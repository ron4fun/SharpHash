...
namespace SharpHash.Hash32.Tests
{
    ...
    {
        protected IHash hash = HashFactory.Hash32.CreateRS();

        protected string ExpectedHashOfEmptyData = "00000000";
        protected string ExpectedHashOfDefaultData = "9EF98E63";
        protected string ExpectedHashOfOnetoNine = "704952E9";
        protected string ExpectedHashOfabcde = "A4A13F5D";
